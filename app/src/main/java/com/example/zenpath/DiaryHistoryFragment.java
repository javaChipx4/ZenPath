...
public class DiaryHistoryFragment extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_diary_history, container, false);
    ...
    private void loadJournalEntries() {
        ArrayList<String> entries = repository.getJournalEntries();
        
        if (entries.isEmpty()) {
            tvEmptyMessage.setVisibility(View.VISIBLE);
            entriesContainer.setVisibility(View.GONE);
            tvEmptyMessage.setText("No diary entries yet. Start writing to see your history here!");
        } else {
